		...
		<div>
			<form name="login" method="post">
				<div class="form-group">
					...
					<input type="text" name="abc" placeholder="<?=__("your login name")?>" class="form-control" required>
				</div>
				<div class="form-group">
					<label for "password">
						<?=__("password")?>
					</label>
					<input type="password" name="efg" placeholder="<?=__("your password")?>" class="form-control" required>
				</div>
				<div class="checkbox">
